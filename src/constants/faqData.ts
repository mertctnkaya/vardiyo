export const FAQ_DATA = [
    {
        ...
        faqs: [
            { q: "Vardiya PRO & ATS Uyumlu Akıllı CV Motoru nedir? Nasıl çalışır?", a: "Vardiya PRO, yalnızca vardiya değil kariyerinizi de yönetmenizi sağlayan Türkiye'nin en gelişmiş mavi yaka ve saha CV oluşturucusudur. İçerisindeki yapay zeka (ATS) destekli motor; girdiğiniz meslek, makine ve tecrübe bilgilerini kurumsal İK robotlarının okuyabileceği en doğru font, satır boşluğu ve yapı standartlarına %100 uyumlu şekilde dönüştürür. 16 ana sektör ve yüzlerce meslek dalı için size teknik yetenek önerileri sunar. Kurumsal ve Atölye olmak üzere iki farklı PDF çıktısı alabilirsiniz." },
