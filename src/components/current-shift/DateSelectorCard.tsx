...
export default function DateSelectorCard({ targetDate, formattedDateValue, onDateChange, onShiftDate, onSetToday, onShareClick }: DateSelectorCardProps) {
  return (
    <div className="card bg-base-100 shadow-xl border border-base-200">
      <div className="card-body items-center text-center w-full">
        ...
        {onShareClick && (
          <div className="w-full max-w-xs mt-6 pt-4 border-t border-base-300">
            <button
              onClick={onShareClick}
              className="btn btn-outline border-indigo-500/30 text-indigo-400 hover:bg-indigo-600 hover:border-indigo-600 hover:text-white w-full flex items-center justify-center gap-2"
            >
